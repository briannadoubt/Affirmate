...
struct UserRouteCollection: RouteCollection {
    ...
    func boot(routes: RoutesBuilder) throws {
        ...
        users.get("find") { request async throws -> [User.Public] in
        ...
        users.get(":userId") { request async throws -> User.Public in
            guard
            ...
            return User.Public(id: userId, username: user.username)
        }
    }
}
